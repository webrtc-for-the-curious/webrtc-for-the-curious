...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f2e0f5a9e78db6af417d7061fdda57a2372256f136161cf921298be160978897.js',function(){input.required=false;search();});}
