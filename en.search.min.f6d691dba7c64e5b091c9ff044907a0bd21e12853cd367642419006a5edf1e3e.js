...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5745be5357ba3c267179ba6870e6453ae155ce6a777372c4439f407a935b912e.js',function(){input.required=false;search();});}
