...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.f40ed09cc6db8f981aa68c8a34ff34cbf3ada1ef754fdbde4bf887dca0fdd318.js',function(){input.required=false;search();});}
