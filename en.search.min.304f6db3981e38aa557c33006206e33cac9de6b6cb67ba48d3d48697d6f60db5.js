...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.43457103604e01bc24f7f05bc0c291a3d773e40c302309cf926dcb0d8def1ff1.js',function(){input.required=false;search();});}
