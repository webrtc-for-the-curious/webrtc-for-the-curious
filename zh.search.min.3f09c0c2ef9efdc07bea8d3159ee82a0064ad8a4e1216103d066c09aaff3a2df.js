...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.ba4fb0ba8e0b99fab43ff50fa151b61dfef23d26ccc77d0c6225ffa9c06a7395.js',function(){input.required=false;search();});}
