...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/sv.search-data.min.678989ccbb79fcaacf3921dfcb62a506cf742c7385a635eaca41ba536e6d9608.js',function(){input.required=false;search();});}
