...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.38e9abdc38cb72d5197bdf545abadf666775fc72a1a94606a3e832484ed5cf0e.js',function(){input.required=false;search();});}
