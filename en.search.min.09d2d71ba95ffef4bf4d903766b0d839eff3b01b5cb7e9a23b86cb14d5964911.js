...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bc266d05a2bbb856829ff9506357c38a8fbb7a1564aa4754c4564fb8aa6c19ef.js',function(){input.required=false;search();});}
