...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.b97461a9a83a9179ffa485cf1247a91bf7da3b0cb5cfad68709e6099779af43f.js',function(){input.required=false;search();});}
