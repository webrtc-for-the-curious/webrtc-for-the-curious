...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0d5893a6c2235f3edcddc6ae6cd24b2b7a099cc7812d0aa7ab8efc62aa5dfe3b.js',function(){input.required=false;search();});}
