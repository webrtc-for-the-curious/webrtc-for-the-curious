...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.f66c38634fb1bac1ee2dd2f2d902fe6215c081e7a27651c72a3050137921c98f.js',function(){input.required=false;search();});}
