...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9a0b6926b197a6b2414e30db41402b90a5dc843be7952ddb87534b3200220cdf.js',function(){input.required=false;search();});}
