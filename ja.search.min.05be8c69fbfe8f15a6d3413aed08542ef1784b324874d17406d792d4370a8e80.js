...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.e5e47db08d3ad2f14b41aacaecaa2f5b41ce2598d0ff8a94d5ae57a1200d58a9.js',function(){input.required=false;search();});}
