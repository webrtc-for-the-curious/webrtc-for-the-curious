...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a0d18ca9319a0e3548e38868546769790f16d5a773552197139f1c37d15d40d9.js',function(){input.required=false;search();});}
