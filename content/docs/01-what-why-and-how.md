...
### new PeerConnection
The PeerConnection is the top level 'WebRTC Session'. It contains all the protocols we talked about above.


### addTrack

addTrack creates a new RTP stream. A random SSRC will be generated for this stream. This stream will then be inside the Session Description generated by createOffer as a dedicated media section.

Immediately after a SRTP Session is established these media packets will start being sent via ICE.
