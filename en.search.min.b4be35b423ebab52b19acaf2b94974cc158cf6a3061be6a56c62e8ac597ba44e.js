...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ced6a1ef35a3602854d1244b909576f07c0bbc16ad49110032160f4ce32f427c.js',function(){input.required=false;search();});}
