...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.64e3a4cea4e0f31a8dd280b40ca5a396cb5105191895224d7ecdd4fc0304cbca.js',function(){input.required=false;search();});}
