...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b0d7a793c359e6d624817dc6191a5a022546025aaae202fc6dc116be3533049c.js',function(){input.required=false;search();});}
