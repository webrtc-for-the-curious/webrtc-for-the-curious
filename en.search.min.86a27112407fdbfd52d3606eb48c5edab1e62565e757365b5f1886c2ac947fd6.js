...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e032243f92b67fe78a3104128d8da6fd556f1d5c5794f99cb86bfeca65fb91df.js',function(){input.required=false;search();});}
