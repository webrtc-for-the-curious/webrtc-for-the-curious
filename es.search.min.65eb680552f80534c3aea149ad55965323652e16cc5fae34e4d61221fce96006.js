...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/es.search-data.min.4937f72f49171c6d61991525e3f123e26ebc2079bfbfff1959722e1b58a0ee57.js',function(){input.required=false;search();});}
