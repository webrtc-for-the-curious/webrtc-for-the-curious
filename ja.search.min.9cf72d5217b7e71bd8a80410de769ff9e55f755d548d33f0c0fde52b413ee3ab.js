...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.cee375588f850c05066555a92964218bcb0c1275317a49deacd007dc1ef344bb.js',function(){input.required=false;search();});}
