...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.eeacd5450e6134f6989567dad4430abf0a5e90fbfe9630cc11ef3a8c92494760.js',function(){input.required=false;search();});}
