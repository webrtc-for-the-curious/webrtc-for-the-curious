...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.699c06d69ee52a2dbfb2341a2d9bbf16f7fdf58bd2ed04db5f527632a9113ff6.js',function(){input.required=false;search();});}
