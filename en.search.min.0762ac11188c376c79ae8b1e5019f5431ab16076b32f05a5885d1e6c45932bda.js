...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.160395bad64fc2dd8bf0493a82d15eac9bd5759575139e32dffed5570bd8455d.js',function(){input.required=false;search();});}
