...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.700cf15ec244dd0340131959d9cd7c4d1ac56f1324273a4cecacf2a8ceabee98.js',function(){input.required=false;search();});}
