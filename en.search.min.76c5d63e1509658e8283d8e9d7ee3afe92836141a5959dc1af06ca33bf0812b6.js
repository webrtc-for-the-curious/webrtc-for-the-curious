...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4cf22d40fcb4953a99eaf78279138e8cfbf11ae2a6505f2d4604a6ce33e0fce7.js',function(){input.required=false;search();});}
