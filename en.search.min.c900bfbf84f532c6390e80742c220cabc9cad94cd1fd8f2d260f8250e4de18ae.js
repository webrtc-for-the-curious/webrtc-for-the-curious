...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dbb73671f079c0114168d44fab10b381db765c2207bd55353a4abe5d1d6bc344.js',function(){input.required=false;search();});}
