...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.7e31421f4551b53616556dd73d0ae8d0a706ee1b26b0ffa91d86dc4e51504e64.js',function(){input.required=false;search();});}
