...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.f422437c7106437ba609fd51d719653996b48294d36a73db59c30bdfb75fd49c.js',function(){input.required=false;search();});}
