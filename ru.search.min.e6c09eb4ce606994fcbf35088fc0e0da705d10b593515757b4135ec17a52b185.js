...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ru.search-data.min.3a6d4df9e22ba18f5244518e272176d65ed25c6dcaef97e89cfdc1259f79a0cd.js',function(){input.required=false;search();});}
