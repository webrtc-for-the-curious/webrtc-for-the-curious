...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fc2a11a57be07113a4734a079cbaa92e71720192092d24f9fcc6748d8d2f9fa6.js',function(){input.required=false;search();});}
