...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b87d262d308dc82a9d730fcccb93dae8c710ba3912616e5179b9ac9832a9efa0.js',function(){input.required=false;search();});}
