...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/tr.search-data.min.b4cf1a68333e60d1f457281a402c028a7a0e6b8a153c1e82db5e7b7aebef93d0.js',function(){input.required=false;search();});}
