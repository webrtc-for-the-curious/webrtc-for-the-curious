...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aa16deb0a06f33fdad15c964c2e877dd60a2f782dee54a8ff55e936f94a44a0a.js',function(){input.required=false;search();});}
