...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.940e9db0646eb078f6c1585ac2233b03423fcbf7afc5827d2f84c0ed18d5e4e2.js',function(){input.required=false;search();});}
