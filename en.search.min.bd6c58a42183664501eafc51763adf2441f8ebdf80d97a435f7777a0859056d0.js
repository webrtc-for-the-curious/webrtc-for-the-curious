...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.948dc79185bcf1325c1dab17a9842d325fde99436a0446d9be884a92f3259fac.js',function(){input.required=false;search();});}
