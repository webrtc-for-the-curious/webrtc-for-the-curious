...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.80da7cbebc898510376acb1ebef2b0689ce69a84a44e1ccc932679d0d8a9cce5.js',function(){input.required=false;search();});}
