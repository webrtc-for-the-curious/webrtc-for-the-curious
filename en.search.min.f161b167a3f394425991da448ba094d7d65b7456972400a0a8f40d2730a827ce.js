...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6646c586613813611e44483403c3534058bd696997fcdf9b6ec89cac050541f3.js',function(){input.required=false;search();});}
