...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/sv.search-data.min.cd5a1393d68e549ddd05fcbe38d201568567382bb0a57280fd696b9854505285.js',function(){input.required=false;search();});}
