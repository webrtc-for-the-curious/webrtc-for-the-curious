...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4afcda95ce346381cdbffdf2c64d483378a0edcfd6a8e1d1437ba2e8fff5161d.js',function(){input.required=false;search();});}
