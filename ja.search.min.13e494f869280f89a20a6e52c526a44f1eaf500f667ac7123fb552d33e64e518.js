...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.cf05fa293fd159521fef85c35178d8ecec69777649b48304074923e26b48e332.js',function(){input.required=false;search();});}
