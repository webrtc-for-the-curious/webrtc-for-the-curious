...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d3e9942386a771148d07c491f957e0f952c3deec6cbdb21477d0192c6a7a52a0.js',function(){input.required=false;search();});}
