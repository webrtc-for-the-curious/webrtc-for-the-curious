...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.fdf56d1795457249a9a8e41f6c60ec2525bbbebbd28c183620ac5068216200a2.js',function(){input.required=false;search();});}
